	...
	<body>
		...
		<div id="show-entry" class="content scaffold-show" role="main">
			...
			<ol class="property-list entry">
				...
				<g:if test="${entryInstance?.aggregatedOn}">
				<li class="fieldcontain">
					<span id="aggregatedOn-label" class="property-label"><g:message code="entry.aggregatedOn.label" default="Aggregated On" /></span>
					
						<span class="property-value" aria-labelledby="aggregatedOn-label"><g:formatDate date="${entryInstance?.aggregatedOn}" /></span>
