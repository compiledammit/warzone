	...
	<body>
		...
		<div id="show-feed" class="content scaffold-show" role="main">
			...
			<ol class="property-list feed">
				...
				<g:if test="${feedInstance?.addedOn}">
				<li class="fieldcontain">
					<span id="addedOn-label" class="property-label"><g:message code="feed.addedOn.label" default="Added On" /></span>
					
						<span class="property-value" aria-labelledby="addedOn-label"><g:formatDate date="${feedInstance?.addedOn}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${feedInstance?.lastUpdatedOn}">
				<li class="fieldcontain">
					<span id="lastUpdatedOn-label" class="property-label"><g:message code="feed.lastUpdatedOn.label" default="Last Updated On" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdatedOn-label"><g:formatDate date="${feedInstance?.lastUpdatedOn}" /></span>
