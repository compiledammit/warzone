			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="specialAdminUserProperty" title="${message(code: 'adminUser.specialAdminUserProperty.label', default: 'Special Admin User Property')}" />
				...
				<g:each in="${adminUserInstanceList}" status="i" var="adminUserInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: adminUserInstance, field: "specialAdminUserProperty")}</td>
