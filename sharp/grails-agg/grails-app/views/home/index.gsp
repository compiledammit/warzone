    ...
    <section id="main" class="span9">
        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <div>
                    <h1>Entries: ${entriesTotal}</h1>
                    <g:each in="${entries}" var="entry">
                        <p>${entry.title} - ${entry.dateCreated}</p>
                    </g:each>
                </div>

                <div class="pagination">
                    <g:paginate total="${entriesTotal}"/>
                </div>
            </div>
            ...
            <div class="span4">
                ...
                <p>You can download, fork &amp; raise issues on this project on <a href="https://github.com/robfletcher/twitter-bootstrap-scaffolding">GitHub</a>.
                </p>
            </div>
